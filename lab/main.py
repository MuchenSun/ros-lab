...
class labShell(cmd.Cmd):
    intro = 'The TurtleBot3 Lab. Type \'help\' or \'?\' for help.'
    prompt = '\nTurtleBot3 >> '
    lab_state = {
        0: 'not loaded',
        1: 'loaded',
    ...
    def do_start_lab(self, arg):
        ...
        if arg in self.lab_list:
            temp_container = self.client.containers.run(self.lab_list[arg][2], command='echo TurtleBot3 Basic Lab Initialized', ports={'80/tcp': ('127.0.0.1', 6080)}, detach=True)
